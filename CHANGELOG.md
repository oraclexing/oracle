...
- API: support the exact `gpt-6-astra` model with model-specific reasoning validation, rejecting unsupported `none` effort before inference and retaining explicit Responses Pro mode.
